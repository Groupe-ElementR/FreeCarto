...
#' @param legend.pos character; position of the legend, one of "topleft", "top", "topright", "left", "right", "bottomleft", "bottom", "bottomright".
...
#' @param legend.values.rnd numeric; number of decimal places of the values in the legend.
#' @param legend.style character; either "a" or "b". The legend has two display styles.
#' @param legend.frame boolean; whether to add a frame to the legend (TRUE) or not (FALSE).

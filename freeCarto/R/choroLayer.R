...
#'
#' @examples
#' choroLayer(spdf = TNdeleg.spdf, df = TNdeleg, var =  "housing", nbclass = 20, pal1="red.pal",pal2="green.pal",breakval=10000,method = "equal",add=FALSE,alpha=TRUE)
#'
#' @return plot
#' @export

choroLayer <- function(spdf, df, spdfid = NULL, dfid = NULL, var, distr=NULL, col = NULL, nbclass=NULL, method="quantile", pal1 = "blue.pal", pal2 = "green.pal", breakval = NULL, alpha = FALSE,add=T)
{
...
# plot(test$spdf, col=test$spdf@data$colMap,border="black",lwd=1,add=T)
